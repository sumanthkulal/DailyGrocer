...
const AddAddress = () => {
    ...
    <div className='mt-16 pb-16'>
        ...
        <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
            <div className='flex-1 max-w-md'>
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    <div className='grid grid-cols-2 gap-4'>
                     ...
                     <InputField handleChange={handleChange} address={address} name='email'  placeholder="email address"
                    type="text"/>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        <InputField handleChange={handleChange} address={address} name='zipcode'  placeholder="Zipcode"
                        type="number"/>
                        <InputField handleChange={handleChange} address={address} name='country'  placeholder="Country"
                        type="text"/>
                    </div>

                    <InputField handleChange={handleChange} address={address} name='phone'  placeholder="Phone"
                        type="text"/>
           ...
           <img className='md:mr-16 mb-16 md:mt-0' src={assets.add_address_iamge} alt="address_iamge" />
        </div>
    </div>
  )
}
